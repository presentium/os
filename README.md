# Presentium OS
This is a fork of the Raspberry Pi OS build system, [pi-gen](https://github.com/RPi-Distro/pi-gen/), with the goal of creating a custom OS for the Presentium project.

The image generated is a minimal Raspberry Pi OS image (headless) with the following changes:

- The default user is `presentium` with password `presentium`
- The hostname is `presentium-device`
- SSH is enabled by default
- Presentium APT repository is added
- Presentium client and dependencies are installed
- automount is installed to automount usb drives at `/mnt/registration-certs`
